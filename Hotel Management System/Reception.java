...
public class Reception extends JFrame {
    Reception(){
        ...
        ImageIcon i111= new ImageIcon(getClass().getResource("/icon/admin.gif"));

        System.out.println(getClass().getResource("/icon/admin.gif"));
        ...
        System.out.println(getClass().getResource("/icon/login.gif"));
